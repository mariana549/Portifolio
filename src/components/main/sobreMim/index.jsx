      ...
      <section className="bg-pink-400 min-h-[500px]" id='sobremim' onClick={handleClick}>
         <Container>
            <div className="flex flex-col items-center py-12 gap-4">
               <h1 className="text-5xl shinning-2 div1 mb-4 font-poppins">Sobre mim</h1>
               <p className="text-lg text-pink-950 font-medium font-poppins">Eu estudo programação desde o ano passado, estudei por um tempo no inicio do ano mas tive que parar. quando foi em outubro eu iniciei no curso da devquest e desde lá estudos constantemente todos os dias.</p>
            ...
            <div className="flex flex-col items-center py-12 gap-4">
               <h2 className="text-4xl shinning-2 div1 mb-4 font-poppins">Tecnologias</h2>
               <ul className="flex flex-wrap gap-2 justify-center">
                  <li className="p-3 bg-black border-2 border-purple-600 rounded-2xl flex items-center">
                     <img
                        src={js}
                        alt="logo"
