...
className="w-5"/> Cursos</li>
                     ...
                     <li className="text-xl p-2 bg-pink-500 hover:shadow-inner hover:shadow-[#0000008c] rounded-lg flex gap-2 items-center transition-[0.5s] ease-in-out"> <img src={contato} alt="contato" className=""/> Contato</li>
                  </ul>
               </nav>
            </div>
         </Container>
